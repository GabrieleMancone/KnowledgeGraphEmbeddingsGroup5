...
if __name__ == '__main__':
    modelName="HarryPotterComplEx"
    model=restore_model(model_name_path='saved_model/best_model_ComplEx_HarryPotter')
    ...
    output=pd.read_pickle('saved_model/resultPredictingLinksHarryPotterComplEx')
    print(output)
    threshold_predicting_links('saved_model/resultPredictingLinksHarryPotterComplEx',10)
    averageMetric('saved_model/resultPredictingLinksHarryPotterComplExThresholded.pkl')
