...
if __name__ == '__main__':
    modelName="ComplEx"
    model=restore_model(model_name_path='saved_model/best_model_ComplEx')
    ...
    output=pd.read_pickle('saved_model/resultPredictingLinksComplEx')
    print(output)
    threshold_predicting_links('saved_model/resultPredictingLinksComplEx', 10)
    averageMetric('saved_model/resultPredictingLinksComplExThresholded.pkl')