...
if __name__ == '__main__':
    ...
    model=ModelSelectionComplEx([10], [500], [200, 150], [10,15],
                                { "negative_corruption_entities": ["all" , "batch"], "corrupt_sides": 's+o'},
    ...
    save_model(best_model, model_name_path='saved_model/best_model_ComplEx')