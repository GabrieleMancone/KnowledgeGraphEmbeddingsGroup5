...
if __name__ == '__main__':
    modelName="HarryPotterTransE"
    model=restore_model(model_name_path='saved_model/best_model_TransE_HarryPotter')
    ...
    output = pd.read_pickle('saved_model/resultPredictingLinksHarryPotterTransE')
    print(output)
    threshold_predicting_links('saved_model/resultPredictingLinksHarryPotterTransE', 10)
    averageMetric('saved_model/resultPredictingLinksHarryPotterTransEThresholded.pkl')