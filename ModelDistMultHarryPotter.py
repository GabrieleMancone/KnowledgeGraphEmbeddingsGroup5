...
class ModelDistMultHarryPotter:
...
if __name__ == '__main__':
    ...
    model=ModelDistMultHarryPotter([10], [500], [200], [15],
    ...
    save_model(best_model, model_name_path='saved_model/best_model_DistMult_HarryPotter')