...
if __name__ == '__main__':
    modelName="DistMult"
    model=restore_model(model_name_path='saved_model/best_model_DistMult')
    ...
    output = pd.read_pickle('saved_model/resultPredictingLinksDistMult')
    print(output)
    threshold_predicting_links('saved_model/resultPredictingLinksDistMult', 10)
    averageMetric('saved_model/resultPredictingLinksDistMultThresholded.pkl')