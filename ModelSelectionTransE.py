...
if __name__ == '__main__':
    ...
    model=ModelSelectionTransE([10], [500], [150, 200], [10,15],
                              { "negative_corruption_entities": ["all" , "batch"], "corrupt_sides": 's+o',"norm": [1],"normalize_ent_emb":False },
    ...
    save_model(best_model, model_name_path='saved_model/best_model_TransE')