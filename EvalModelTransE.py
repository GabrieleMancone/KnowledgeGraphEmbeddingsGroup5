...
if __name__ == '__main__':
    modelName="TransE"
    model=restore_model(model_name_path='saved_model/best_model_TransE')
    ...
    output=pd.read_pickle('saved_model/resultPredictingLinksTransE')
    print(output)
    threshold_predicting_links('saved_model/resultPredictingLinksTransE', 10)
    averageMetric('saved_model/resultPredictingLinksTransEThresholded.pkl')