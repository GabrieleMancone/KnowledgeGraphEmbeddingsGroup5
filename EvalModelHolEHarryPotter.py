...
if __name__ == '__main__':
    modelName="HarryPotterHolE"
    model=restore_model(model_name_path='saved_model/best_model_HolE_HarryPotter')
    ...
    output = pd.read_pickle('saved_model/resultPredictingLinksHarryPotterHolE')
    print(output)
    threshold_predicting_links('saved_model/resultPredictingLinksHarryPotterHolE', 10)
    averageMetric('saved_model/resultPredictingLinksHarryPotterHolEThresholded.pkl')